          ...
          >
            ...
            <figcaption className="mb-15">
              ...
              <div className="flex flex-wrap font-Open-sans text-fs-15">
                ...
                <div className="w-1/2 xs:w-full mb-8">
                  ...
                  <span className="project-label">Used Thecnologies </span>:{" "}
                ...
                <div className="w-1/2 xs:w-full mb-8">
                  ...
                  <span className="font-semibold">{popup.link}</span>
                </div>
                <div className="w-1/2 xs:w-full mb-8">
            ...
            {/* {popup.type == "Resume" ? (
              <video
                ...
                poster={popup.img}
              >
                <a href="assets/img/projects/Resume.docx" target = "_blank">link</a>
              </video>
            ) : popup.type == "youtube" ? (
