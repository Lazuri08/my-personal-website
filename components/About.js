...
const bio = [
  {
    id: 11,
    data: [
      { id: 1, type: "First Name", value: "Gorkem" },
      { id: 2, type: "Last Name", value: "SARI" },
      { id: 3, type: "Age", value: "28" },
      { id: 4, type: "Nationality", value: "Turkish" },
  ...
  },
  {
    id: 12,
    data: [
      { id: 6, type: "Address", value: "Toronto, ON, Canada" },
      { id: 7, type: "Phone", value: "6479047020" },
      { id: 8, type: "Email", value: "gorkemsaricad@gmail.com" },
      // { id: 9, type: "Skype", value: "steve.milner" },
      { id: 10, type: "Languages", value: "Turkish, English" },
    ],
  },
];
...
const experiences = [
  ...
  },
  {
    ...
    company: "Kavram College"
  },
  {
    id: 4,
    date: "2015 - 2018",
    title: "Chess Instructor",
    company: "Sinav College"
  },
  {
    id: 5,
    date: "2018",
    title: "Intern",
    company: "Prismian Group INC",
    desc: "Internship as Electrical Engineer",
  },
];
...
const educations = [
  {
    ...
    unv: "George Brown College",
    desc: "Computer Programming and Analysis",
  },
  {
    id: 2,
    date: "2018",
    title: "Bachelor Degree",
    unv: "Uludag University",
    desc: "Electric and Electronic Engineer",
  },
  {
    id: 3,
    date: "2013",
    title: "Bachelor Degree",
    unv: "Hopa High School",
...
const skills = [
  ...
  { id: 5, name: "java", value: "75" },
  { id: 6, name: "jquery", value: "60" },
  { id: 7, name: "c#", value: "75" },
  { id: 8, name: "react", value: "65" },
  { id: 9, name: "python", value: "75" },
  { id: 10, name: "data structures", value: "85" },
  { id: 11, name: "SQL", value: "75" },
  { id: 12, name: "python", value: "75" }
    ...
    <SectionContainer id="about">
      <div className="w-full">
        ...
        <div className="xl:max-w-1140 custom-md-3:max-w-[calc(100%-195px)] lg:max-w-960 md:max-w-720 sm:max-w-540 xs:max-w-full mx-auto">
          ...
          />
          <h3 className="uppercase text-fs-26 xs:text-fs-21 pb-48 text-red font-semibold text-center">
            my skills
          </h3>
          {/* Skills Starts */}
